...
type Querier interface {
	...
	CountDocsByProject(ctx context.Context, projectID int64) (int64, error)
	...
	CountReleasesByProject(ctx context.Context, projectID int64) (int64, error)
	...
	CreateWorkspace(ctx context.Context, arg CreateWorkspaceParams) (Project, error)
	...
	GetDocProjectID(ctx context.Context, id int64) (int64, error)
	...
	GetLatestRelease(ctx context.Context, projectID int64) (GetLatestReleaseRow, error)
	...
	GetReleaseProjectID(ctx context.Context, id int64) (int64, error)
	// ============================================
	// Session Queries
	// ============================================
	...
	// ============================================
	GetWorkspaceByID(ctx context.Context, id int64) (Project, error)
	GetWorkspaceByKey(ctx context.Context, key string) (Project, error)
	IsUserAdmin(ctx context.Context, id int64) (bool, error)
	...
	ListAllWorkspaces(ctx context.Context) ([]Project, error)
	...
	ListDocsByProject(ctx context.Context, projectID int64) ([]ListDocsByProjectRow, error)
	...
	ListReleasesByProject(ctx context.Context, projectID int64) ([]ListReleasesByProjectRow, error)
	ListUserSessions(ctx context.Context, userID int64) ([]Session, error)
	ListUsers(ctx context.Context) ([]User, error)
	ListWorkspaceMembers(ctx context.Context, projectID int64) ([]ListWorkspaceMembersRow, error)
	ListWorkspacesForUser(ctx context.Context, arg ListWorkspacesForUserParams) ([]Project, error)
	...
	RemoveAllWorkspaceMembers(ctx context.Context, projectID int64) error
	...
	UserHasWorkspaceAccess(ctx context.Context, arg UserHasWorkspaceAccessParams) (sql.NullBool, error)
}
