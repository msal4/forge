-- ============================================
-- Sarray Forge - Add reaction notification type
-- Migration: 009_reaction_notification_type.sql
-- ============================================

-- SQLite doesn't support ALTER TABLE to modify CHECK constraints
-- We need to recreate the table with the new constraint

-- Step 1: Create new table with updated constraint (adding 'reaction')
CREATE TABLE IF NOT EXISTS notifications_new (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    user_id INTEGER NOT NULL,
    actor_id INTEGER NOT NULL,
    notification_type TEXT NOT NULL
        CHECK(notification_type IN ('mention', 'assigned', 'comment_on_owned', 'comment_on_assigned', 'entity_updated', 'entity_deleted', 'reaction')),
