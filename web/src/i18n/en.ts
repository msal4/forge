export default {
	...
	invite: {
		title: 'Join Sarray Forge',
		subtitle: 'Create your account for {{username}}',
		workspaces: 'You will have access to',
		password: 'Password',
		...
		adminTitle: 'Invite new user',
		adminDescription: 'Generate an expiring link for a new team member to set their password.',
		usernamePlaceholder: 'Username (e.g. zahra)',
		fullNamePlaceholder: 'Full name (optional)',
		selectWorkspaces: 'Workspaces to grant access',
		expiresOneDay: 'Expires in 1 day',
		expiresTwoDays: 'Expires in 2 days',
	...
	settings: {
		...
		// API Tokens
		apiTokens: 'API Keys',
		apiTokensDescription: 'Create personal API keys for Cursor MCP and other automation tools.',
		apiTokensNamePlaceholder: 'Key name (e.g. Cursor Agent)',
		apiTokensCreate: 'Create key',
		apiTokensCopyOnce: 'Copy this key now — it will not be shown again.',
		apiTokensCopy: 'Copy',
		apiTokensCopied: 'Copied',
		apiTokensDismiss: 'I saved this key',
		apiTokensEmpty: 'No API keys yet',
		apiTokensCreated: 'Created {{date}}',
		apiTokensLastUsed: 'Last used {{date}}',
		apiTokensNeverUsed: 'Never used',
		apiTokensRevokeTitle: 'Revoke API key',
		apiTokensRevokeMessage: 'Revoke "{{name}}"? Applications using this key will stop working.',
		apiTokensRevokeConfirm: 'Revoke',
		apiTokensLoadFailed: 'Failed to load API keys',
		apiTokensCreateFailed: 'Failed to create API key',
		apiTokensRevokeFailed: 'Failed to revoke API key',
		apiTokensCopyFailed: 'Failed to copy to clipboard',
	},
